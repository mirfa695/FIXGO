...
class page3_5 extends StatefulWidget {
  const page3_5({Key? key}) : super(key: key);

  @override
  State<page3_5> createState() => _page3_5State();
}

class _page3_5State extends State<page3_5> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text('Side Mirror',style: TextStyle(color: Colors.blue[900],fontWeight: FontWeight.bold)),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Align(
                    ...
                    child: Text('₹4,311',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 30))),
              ),
            ),
            Padding(
                  ...
                  children: [
                    ...
                    Container(
                      child: Row(
                          children: [
                            ...
                            Text('Side mirror(OES)',style: TextStyle(color: Colors.black,fontSize:20)),]),
                    ),
                    SizedBox(height: 15,),
                    Row(
                        children: [
                    ...
                    Row(
                        children: [
                          ...
                          Text('Switch charges additional',style: TextStyle(color: Colors.black,fontSize:20)),]),
                    SizedBox(height: 15,),
