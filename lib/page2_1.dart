...
class _page2_1State extends State<page2_1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text('Front & rear side',style: TextStyle(color: Colors.blue[900],fontWeight: FontWeight.bold)),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Align(
                    ...
                    child: Text('₹2,500',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 30))),
              ),
            ),
            Padding(
