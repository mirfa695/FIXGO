...
class page5_6 extends StatefulWidget {
  const page5_6({Key? key}) : super(key: key);

  @override
  State<page5_6> createState() => _page5_6State();
}

class _page5_6State extends State<page5_6> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text('Matte',style: TextStyle(color: Colors.blue[900],fontWeight: FontWeight.bold)),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Align(
                    ...
                    child: Text('₹11,999',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 30))),
              ),
            ),
            Padding(
