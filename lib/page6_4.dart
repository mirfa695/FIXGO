            ...
            Padding(
              ...
              child: Container(
                ...
                child: Align(
                    ...
                    child: Text('₹10,000',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 30))),
              ),
            ),
            Padding(
                  ...
                  children: [
                    ...
                    Row(
                        children: [
                          ...
                          Text('Real time claim tracking',style: TextStyle(color: Colors.black,fontSize:20))]),
                    SizedBox(height: 15,),
                    Row(
                        children: [
                          SizedBox(width: 10,),
